...
import { IHistoryScopeItem } from '@hv/scopes/data/interfaces/detailScopes.interface';
import styles from './HistoryScope.module.css';
import { colors } from '@entropy/icon/Icon';

interface HistoryScopeProps {
  history: IHistoryScopeItem[];
}

export const HistoryScope = ({ history }: HistoryScopeProps) => {
  return (
        ...
        {history.length === 0 ? (
          <div className={styles.infoRow}>
            <BiaText
              ...
              color='weak'
            >
              No hay historial para esta frontera.
            </BiaText>
          </div>
        ) : (
